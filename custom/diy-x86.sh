...
# 修改系统文件
curl -fsSL https://raw.githubusercontent.com/0118Add/X86-N1-Actions/main/general/system.js > ./feeds/luci/modules/luci-mod-status/htdocs/luci-static/resources/view/status/include/10_system.js

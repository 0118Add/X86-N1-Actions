...
svn co https://github.com/Lienol/openwrt-packages/trunk/utils/dockerd package/dockerd
svn co https://github.com/Lienol/openwrt-packages/trunk/utils/docker package/docker
